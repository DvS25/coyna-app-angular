...
@Component({
    selector: 'app-edit-customerinvoice',
    templateUrl: './edit-customerinvoice.component.html',
    styleUrls: ['./edit-customerinvoice.component.scss']
})
export class EditCustomerinvoiceComponent {
