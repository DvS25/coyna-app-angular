...
@Component({
    ...
    templateUrl: './customerinvoice-listing.component.html',
    styleUrls: ['./customerinvoice-listing.component.scss']
})
export class CustomeraccountComponent {
    ...
    public filterOptions: any = [{id:'Company Name',value:'Company Name'},{id:'Store Name',value:'Store Name'},
        {id:'Vendor',value:'Vendor'},{id:'Invoice Number',value:'Invoice Number'},{id:'Invoice Date',value:'Invoice Date'},
        {id:'Due Date',value:'Due Date'},{id:'Payment Status',value:'Payment Status'}];
    public paymentStatus: any = [{id:'Completed',value:'Completed'},{id:'New',value:'New'},{id:'Pending',value:'Pending'}];
    ...
    show(){
        console.log(this.filterForm?.value?.filterOption == 'Store Name')
    }
