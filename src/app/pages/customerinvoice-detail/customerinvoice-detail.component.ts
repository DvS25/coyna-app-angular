...
@Component({
    selector: 'app-customerinvoiced',
    templateUrl: './customerinvoice-detail.component.html',
    styleUrls: ['./customerinvoice-detail.component.scss']
})

export class CustomerinvoicedComponent {
    itemList: any;
    constructor(
