...
@Component({
  selector: 'app-customer-associations',
  templateUrl: './customer-associations.component.html',
  styleUrls: ['./customer-associations.component.scss']
})

export class CustomerAssociationsComponent {
